---
description: Abnegation — add pagination + limits to a list endpoint (and bound any unbounded query), with a consistent page/response shape.
argument-hint: <list endpoint or query to paginate>
---

Launch the `abnegation` subagent (Team Divergent — Senior Backend Developer & Architect) to add pagination to: **$ARGUMENTS**
