---
description: Four — write a safe, additive, reversible database migration (with DB-level constraints) using the repo's migration tooling.
argument-hint: <schema change to make>
---

Launch the `four` subagent (Team Divergent — Senior Backend Developer & Architect) to create a migration for: **$ARGUMENTS**
