---
description: Four — harden an endpoint by enforcing authentication + per-resource authorization (ownership/role), rate-limiting abuse, and sanitizing inputs/outputs.
argument-hint: <endpoint or handler to secure>
---

Launch the `four` subagent (Team Divergent — Senior Backend Developer & Architect) to secure: **$ARGUMENTS**
