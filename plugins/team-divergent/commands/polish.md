---
description: Three — a visual polish pass (hierarchy, alignment, typography, consistency) that removes the generic "AI-generated" look without changing behavior.
argument-hint: [file, component, or page — defaults to recent UI changes]
---

Launch the `three` subagent (Team Divergent — Senior Frontend Engineer) to polish: **$ARGUMENTS** (default: recently changed UI files).
