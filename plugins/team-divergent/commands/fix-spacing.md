---
description: Three — audit and fix spacing/layout rhythm to the 8pt grid (margins, padding, gaps), removing magic values and inconsistent gaps.
argument-hint: [file, component, or page — defaults to recent UI changes]
---

Launch the `three` subagent (Team Divergent — Senior Frontend Engineer) to fix spacing on: **$ARGUMENTS** (default: recently changed UI files).
